    ...
    <section className="relative h-[56vh] p-0 m-0">
      ...
      <div className="absolute inset-0 flex items-center h-full px-4 md:px-8 z-20">
        <div className="text-white w-full lg:w-3/5 space-y-6 pl-8 lg:pl-16 text-left">
          <h4 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-bold mb-4 animate__animated animate__fadeInUp">
            Plan tours to dream <br /> locations in just a click!
          </h4>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl animate__animated animate__fadeInUp animate__delay-1s">
